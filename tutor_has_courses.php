...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="home.php" class="logo">HOME<span></span> <span class="lite">TUITION</span></a>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          $query = "SELECT  ( SELECT TutName from  Tutor where  idTutor =Tutor_idTutor  ) as TutName, GROUP_CONCAT( ( SELECT DISTINCT  CourseName FROM `Courses`  where idCourses = Courses_idCourses ) SEPARATOR  ', ') as 'Tutor_Courses'
                            FROM Tutor_has_Courses  GROUP BY   Tutor_idTutor";
                          ...
                          ?>
                              <tr>
                                 ...
                                 <td><?php echo $row['Tutor_Courses']; ?></td>
